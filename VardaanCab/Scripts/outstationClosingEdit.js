...
$("#JourneyStartDate").datepicker({
    ...
    dateFormat: 'yy-mm-dd',
     onSelect: function (dateText, inst) {
         var txtJourneyEnd = $("#JourneyClosingDate");
         var eDate = txtJourneyEnd.val();
         var txtDays = $("#OutStationDays");
         $.get(`/Booking/GetDays?startDays=${dateText}&endDays=${eDate}`)
             .then(function (r) {
                 txtDays.val(r);
                 calculateKms();
                 calculateGt();
